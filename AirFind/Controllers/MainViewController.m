...
//  AirFind
//
//  Created by Артем Полушин on 07.01.18.
...
@property (nonatomic) UIView *placeContainerView;
@property (nonatomic) UIButton *arrivalButton;
@property (nonatomic) UIButton *departureButton;
...
- (void)placeButtonDidTap:(UIButton *)sender {
    ...
    } else if ([sender isEqual: _departureButton]) {
...
-(void)setPlace:(id)place withDataType:(DataSourceType)dataType andPlaceType:(PlaceType)placeType forButton:(UIButton *)button {
    ...
    if(placeType == PlaceTypeArrival) {
        _searchRequest.destination = iata;
    } else if (placeType == PlaceTypeDeparture) {
